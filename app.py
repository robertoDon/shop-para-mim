...
@app.route('/fix-estoque')
def fix_estoque():
    """Endpoint alternativo para corrigir estoque"""
    # Limpa estoque atual
    for p in Produto.query.all():
        db.session.delete(p)
    db.session.commit()
    
    # Apenas os 6 SKUs corretos
    produtos = [
        ('554724-173', 'Nike', 'Air Max 270', 'Preto', '42', 799.90, '/static/shoes/554724-173.jpeg'),
        ('CN8490-002', 'Nike', 'Air Force 1', 'Branco', '41', 749.90, '/static/shoes/CN8490-002.webp'),
        ('CT8527-100', 'Nike', 'Air Max 90', 'Cinza', '40', 899.90, '/static/shoes/CT8527-100.jpeg'),
    ...
    for sku, marca, modelo, cor, tamanho, preco, imagem_url in produtos:
        produto = Produto(
            sku=sku,
            marca=marca,
            modelo=modelo,
    ...
    db.session.commit()
    return "Estoque corrigido com 6 itens: 554724-173, CN8490-002, CT8527-100, CZ0790-106, DD1391-100, DM7866-140"
